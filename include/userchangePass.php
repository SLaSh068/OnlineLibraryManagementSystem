...
<?php 
	if (isset($_REQUEST['upBtn'])) {
		...
		$sql = "UPDATE users_tab SET users_pass = '$npass' WHERE users_email = '$opass' ";
				mysql_query($sql);
				header('Location:login.php');
	}
?>
							...
							<td align="center">
								<form action="" method="POST">
									<table align="center">
										<tr>
											<td align="right">
												<input type="text" name="opass" placeholder="Enter Current Password">
											</td>
											<td>
										...
										<tr >
											<td colspan="2" align="center">
												<input type="submit" name="upBtn" value="Change Password" class="regBtn">
											</td>
										</tr>
									</table>
								</form>
