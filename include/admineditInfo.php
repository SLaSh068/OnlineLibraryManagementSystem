...
<?php 
	if (isset($_REQUEST['save'])) {
		...
		$sql = "UPDATE admin_tab SET users_fname = '$fname', users_lname = '$lname', cl = '$cl', ai = '$ai' WHERE users_email = '$email' ";
		mysql_query($sql);
	}
	...
	if (isset($_REQUEST['ques'])) {
		$sec = $_REQUEST['sec'];
		$email = $_SESSION['email'];
		$sql = "UPDATE admin_tab SET sec_ques = '$sec' WHERE users_email = '$email' ";
		mysql_query($sql);
	}
	...
	$sql="UPDATE admin_tab SET users_dp ='$path' WHERE users_email = '$email' ";
	mysql_query($sql) or die(mysql_error());
	$res=mysql_query("SELECT users_dp FROM admin_tab WHERE users_email = '$email' ");
	}
										...
										<tr>
											<td align="left">
												First Name : <input type="text" name="fname" value="<?php 
													$email = $_SESSION['email'];
													$sql = "SELECT users_fname from admin_tab WHERE users_email = '$email' ";
										...
										<tr>
											<td align="left">
												Last Name : <input type="text" name="lname" value="<?php 
													$email = $_SESSION['email'];
													$sql = "SELECT users_lname from admin_tab WHERE users_email = '$email' ";
													$result = mysql_query($sql);
													$rws = mysql_fetch_array($result);
													echo $rws[0];
												?>">
